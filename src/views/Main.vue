      ...
      <el-container>
        <el-aside :style="{width:switchCollapseWidth}">
          <el-menu router :collapse="isCollapse" class="el-menu-vertical-demo">
            ...
            <el-submenu index="1">
              <template slot="title">
                <i class="el-icon-s-management"></i><span slot="title">物资信息管理</span>
              </template>
            ...
            <el-submenu index="2">
              <template slot="title"><i class="el-icon-s-goods"></i><span slot="title">采购管理</span></template>
            ...
            <el-submenu index="4">
              <template slot="title"><i class="el-icon-s-order"></i><span slot="title">销售管理</span></template>
            ...
            <el-submenu index="3">
              <template slot="title"><i class="el-icon-s-custom"></i><span slot="title">客户/供应商管理</span></template>
                <el-menu-item index="3-1">客户信息管理</el-menu-item>
                <el-menu-item index="3-2">供应商信息管理</el-menu-item>
            </el-submenu>
            <el-submenu index="5">
              <template slot="title"><i class="el-icon-s-home"></i><span slot="title">仓库管理</span></template>
            ...
            <el-submenu index="6">
              <template slot="title"><i class="el-icon-s-data"></i><span slot="title">综合查询</span></template>
